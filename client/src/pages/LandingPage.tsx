...
export default function LandingPage() {
  ...
  const handlers = useSwipeable({
    onSwipedUp: () => {
      if (activeSection < sections.length - 1) {
        const nextSection = document.getElementById(sections[activeSection + 1]);
        nextSection?.scrollIntoView({ behavior: "smooth" });
      }
    },
    onSwipedDown: () => {
      if (activeSection > 0) {
        const prevSection = document.getElementById(sections[activeSection - 1]);
  ...
  const sectionClass = "h-screen snap-start snap-always flex items-center relative overflow-y-hidden";
  const containerClass = "container mx-auto px-4 py-8 md:py-0"; // Added padding for mobile
  const contentWrapperClass = "max-w-4xl mx-auto space-y-8 flex flex-col h-full justify-center"; // Added flex and height control
  ...
  return (
    ...
    >
      ...
      {/* Hero Section */}
      <section id="hero" className="h-screen snap-start snap-always flex items-center relative">
        <NetworkAnimation 
          desktopHouses={10}
          desktopPeople={10}
          mobileHouses={7}
      ...
      {/* Info Section */}
      <section id="info" className="h-screen snap-start snap-always flex items-start pt-10 md:pt-24 relative">
        <div className="container mx-auto px-4">
          <motion.div 
          ...
          >
            ...
            >
              ...
              >
                הסוכנים החכמים שלנו סורקים באופן רציף את כל המודעות החדשות ומתריעים בכל פעם שיש דירה חדשה בשוק
              </motion.p>
                ...
                {[
                  ...
                  >
                    ...
                    >
                      ...
                      <span className="text-3xl transform inline-block">{item.icon}</span>
                    </motion.div>
                    <span className="text-base md:text-lg font-medium text-center">{item.text}</span>
                    <span className="text-xs md:text-sm text-muted-foreground text-center">{item.description}</span>
                  </motion.div>
                ))}
              </div>
            </motion.div>
      ...
      <section id="bot" className="h-screen snap-start snap-always flex items-start pt-10 md:pt-24 relative">
        <div className="container mx-auto px-4">
          <motion.div 
            className="max-w-4xl mx-auto space-y-4"
            initial={{ opacity: 0 }}
          ...
          >
            ...
            >
              <motion.p 
                ...
                transition={{ delay: 0.2 }}
              >
                הגדירו את הפילטרים המדויקים שלכם וקבלו התראות מיידיות על דירות חדשות שמתאימות בדיוק לדרישות שלכם
              </motion.p>
      ...
      <section id="telegram" className="h-screen snap-start snap-always flex items-center relative overflow-y-hidden">
          ...
          >
            ...
            >
              <motion.p 
                ...
                transition={{ delay: 0.2 }}
              >
                הצטרפו לקבוצות הטלגרם השכונתיות שלנו וקבלו עדכונים על דירות חדשות ישירות לנייד
              </motion.p>
                ...
                {[
                  ...
                  >
                    <div className="flex flex-col md:flex-row items-center md:items-center gap-2 md:gap-4 text-center md:text-left">
                      ...
                      <span className="text-sm md:text-lg font-medium">{group.name}</span>
                    </div>
                    <motion.div
      ...
      {/* Contact Section */}
      <section id="contact" className="h-screen snap-start snap-always flex items-center relative">
        <div className="container mx-auto px-4">
          <motion.section 
            className="py-24"
            initial={{ opacity: 0 }}
